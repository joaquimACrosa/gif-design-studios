  ...
  <style>
    ...
    <?php $project_color = 'colorAlexshalman'; ?>
  ...
  <?php include ('../shared/head-off.php');?> <!-- INCLUDE BOTTOM OF HEAD -->
  ...
  <main id="portfolio-page">
    <div>
      ...
      <div class="cell col-6 desktop" >
        <div class="square-responsive square-image1"><img src="../img/GIF-AlexShalman-03.png" alt="AlexShalman" class="full-width"></div>
      </div>
      <div class="col col-12 tablet" ><img src="../img/GIF-AlexShalman-04.png" alt="AlexShalman" class="full-width"></div>
